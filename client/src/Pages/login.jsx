    ...
    <div className="h-screen w-screen bg-gray-100 flex items-center justify-center p-4 font-sans overflow-hidden">
      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden relative flex flex-col h-[850px] max-h-[90vh]">
        ...
        <div className={`${themeColor} pt-8 pb-16 px-6 rounded-b-[40px] relative z-10`}>
          <button className="bg-white/20 text-white mb-8 hover:bg-white/30 p-3 rounded-full transition-all shadow-lg backdrop-blur-sm">
            <ArrowLeft size={24} />
          </button>
            ...
            {view === 'signup' && (
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3.5 rounded-xl border border-gray-200 focus:border-[#1e1b4b] focus:ring-1 focus:ring-[#1e1b4b] outline-none shadow-sm text-gray-700"
            ...
            {view !== 'forgot' && (
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-12 pr-12 py-3.5 rounded-xl border border-gray-200 focus:border-[#1e1b4b] focus:ring-1 focus:ring-[#1e1b4b] outline-none shadow-sm text-gray-700"
                  onChange={handleChange}
                />
                <button
                  type="button"
            ...
            {view === 'forgot' && (
              <div className="text-right">
                <button 
                  type="button" 
                  onClick={() => setView('signin')}
                  className="text-sm text-[#1e1b4b] font-semibold hover:underline"
                >
                  Back to Sign In
                </button>
              </div>
            ...
            <div className="mt-8 max-w-sm mx-auto w-full">
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="text-gray-500 text-sm font-medium px-4">
                  Or {view === 'signup' ? 'sign up' : 'sign in'} with
                </span>
                <div className="h-[1px] bg-gray-300 flex-1"></div>
              </div>
              ...
              <div className="flex gap-4 justify-center">
                {/* Google Button */}
                <button className="flex-1 bg-white border border-gray-200 py-3 rounded-2xl shadow-sm flex items-center justify-center gap-2 hover:bg-gray-50 transition transform active:scale-95">
                ...
                {/* Facebook Button */}
                <button className="flex-1 bg-[#1877F2] py-3 rounded-2xl shadow-sm flex items-center justify-center gap-2 hover:bg-[#156ad8] transition transform active:scale-95">
